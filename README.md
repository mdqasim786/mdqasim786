...
Modern, responsive websites and full SaaS products built with React, Next.js & TypeScript

**🎨 Figma → Production Code**
Pixel-perfect conversion of complex design systems into scalable, responsive UIs

</td>
<td width="50%">

**🤖 AI Systems & Automation**
AI-powered agents, chat interfaces, and business process automation

**📈 SEO & Growth**
Technical SEO and performance optimization for web products
...
| Project | Description |
|---|---|
| **[Exeton](https://exeton.com/)** | Enterprise platform for **an NVIDIA Official Partner** — converted 40+ Figma designs into responsive Next.js pages with an international team |
| **[NeuroniX](https://neuronix-agency.vercel.app/)** | My agency's official site — Next.js, TypeScript, Tailwind CSS |
| **[QuickBill](https://mdquickbill.netlify.app/)** | SaaS billing application — React, Tailwind CSS, Firebase |
| **[react-ai-chatkit](https://www.npmjs.com/package/react-ai-chatkit)** | Published npm package — a customizable React/TypeScript chat UI kit for AI assistants & SaaS apps |
| **[Apex Kicks](https://apexkicks.netlify.app/)** | Modern sneaker store landing page — React, TypeScript, Tailwind CSS |
